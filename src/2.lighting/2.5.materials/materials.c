...
#include <fs_materials_light.sc.glsl.bin.h>
#include <fs_materials.sc.glsl.bin.h>
#include <vs_materials_light.sc.glsl.bin.h>
#include <vs_materials.sc.glsl.bin.h>
#elif BX_PLATFORM_OSX
#include <fs_materials_light.sc.mtl.bin.h>
#include <fs_materials.sc.mtl.bin.h>
#include <vs_materials_light.sc.mtl.bin.h>
#include <vs_materials.sc.mtl.bin.h>
#elif BX_PLATFORM_WINDOWS
#include <fs_materials_light.sc.dx11.bin.h>
#include <fs_materials.sc.dx11.bin.h>
#include <vs_materials_light.sc.dx11.bin.h>
#include <vs_materials.sc.dx11.bin.h>
#endif
#include <camera.h>
...
#if BX_PLATFORM_LINUX || BX_PLATFORM_BSD
  shader_program =
      load_shader_embedded(vs_materials_glsl, sizeof(vs_materials_glsl),
                           fs_materials_glsl, sizeof(fs_materials_glsl));
  light_program = load_shader_embedded(vs_materials_light_glsl, sizeof(vs_materials_light_glsl),
                                       fs_materials_light_glsl, sizeof(fs_materials_light_glsl));
#elif BX_PLATFORM_OSX
  shader_program =
      load_shader_embedded(vs_materials_mtl, sizeof(vs_materials_mtl),
                           fs_materials_mtl, sizeof(fs_materials_mtl));
  light_program = load_shader_embedded(vs_materials_light_mtl, sizeof(vs_materials_light_mtl),
                                       fs_materials_light_mtl, sizeof(fs_materials_light_mtl));
#elif BX_PLATFORM_WINDOWS
  shader_program =
      load_shader_embedded(vs_materials_dx11, sizeof(vs_materials_dx11),
                           fs_materials_dx11, sizeof(fs_materials_dx11));
  light_program = load_shader_embedded(vs_materials_light_dx11, sizeof(vs_materials_light_dx11),
                                       fs_materials_light_dx11, sizeof(fs_materials_light_dx11));
#endif
