...
PosColorVertex s_vertices[4] = {
    { 0.5f,  0.5f, 0.0f, 0xff0000ff }, // top right [0]
    { 0.5f, -0.5f, 0.0f, 0xff00ff00 }, // bottom right [1]
    { -0.5f,  -0.5f, 0.0f, 0xff0000ff }, // bottom left [2]
    { -0.5f,  0.5f, 0.0f, 0xffff0000 } // top left [3]
};
