...
#include <fs_textures_combined.sc.dx11.bin.h>
...
#elif BX_PLATFORM_WINDOWS
  shader_program = load_shader_embedded(vs_textures_combined_dx11, sizeof(vs_textures_combined_dx11), fs_textures_combined_dx11, sizeof(fs_textures_combined_dx11));
#endif
