...
void setup_buffers_and_shaders() {
  ...
  shader_program = load_shader_embedded((uint8_t*)vs_textures_combined_mtl, sizeof(vs_textures_combined_mtl), (uint8_t*)fs_textures_exercise_1_mtl, sizeof(fs_textures_exercise_1_mtl));
